   ...
   ========================================================================== */
    ...
    function badges() {
        ...
        $.getJSON(t, function (e) {
            ...
            var d = i -1;
            $("small", $("#treehouse-count")).append('Completed ' + d + ' Lessons');
        });
    }
    ...
    function charts() {
        var radarChartData = {
            labels: ["Development & Tools", "WordPress", "Ruby & JS", "HTML & CSS", "PHP & MySQL"],
            datasets: [
                {
                    label: "Spenser Hale's Skills",
                    ...
                    data: [1552,1743,1075,1916,2266]
                }
            ]
        };

        window.myRadar = new Chart(document.getElementById("mySkillsChart").getContext("2d")).Radar(radarChartData, {
            responsive: true
        });
    }
